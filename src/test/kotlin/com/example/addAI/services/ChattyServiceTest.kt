...
class ChattyServiceTest {
    ...
    private val chattyService = ChattyService(conversionService, databaseData)
    ...
    @Test
    fun getAnswerTest() {
        `when`(frankfurterMockClient.getRates()).thenReturn(rates.getRates())
        ...
        assertTrue(databaseData.jokes().contains(result3))
